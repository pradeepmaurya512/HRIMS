...
namespace AquatroHRIMS.Models
{
    ...
    public partial class HRIMSdbEntities : DbContext
    {
        public HRIMSdbEntities()
            : base("name=HRIMSdbEntities")
        {
        }
        ...
        public virtual DbSet<tblCompletion> tblCompletions { get; set; }
        public virtual DbSet<tblGoalTitle> tblGoalTitles { get; set; }
    }
}
